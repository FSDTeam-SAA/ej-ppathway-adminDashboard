...
export const SITE_CONTENT_PAGES = [
  ...
  { slug: "login", label: "Login", description: "Login form title, helper copy, placeholders, and links." },
  { slug: "signup", label: "Sign Up", description: "User sign-up form labels, placeholders, terms copy, and links." },
  { slug: "join-as-advisor", label: "Join as Advisor", description: "Hero, joining process, requirements, advisor testimonials." },
  { slug: "advisor-application", label: "Advisor Application Form", description: "Copy, labels, upload instructions, and consent text for /join-as-advisor/apply." },
